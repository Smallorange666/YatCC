...
static const std::unordered_map<std::string, size_t> kClangTokens{
  ...
  { "l_paren", kLeftParen },
  { "r_paren", kRightParen },
  { "l_square", kLeftSquare },
  { "r_square", kRightSquare },
  { "l_brace", kLeftBrace },
  { "r_brace", kRightBrace },

  { "plus_plus", kPlusPlus },
  { "minus_minus", kMinusMinus },
  { "plus_assign", kPlusAssign },
  { "minus_assign", kMinusAssign },
  { "star_assign", kStarAssign },
  { "slash_assign", kSlashAssign },
